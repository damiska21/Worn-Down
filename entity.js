...
//#region PLAYER
var player = new entity(100, 100, 102, 45, 5, 10);
...
function playerFunc() {
    ...
    if (player.Y<0) {
        player.Y=0;
    }if (player.Y > TM.A[0].height*TM.tile+250) {//respawn je 250 pixelů pod spodkem mapy
        player.Y = TM.respawnY;
        player.X = TM.respawnX;
    }if (player.X < 0) {
        player.X = 0;
    }if (player.X > 90 * TM.A[0].width-90) {
        player.X = (90 * TM.A[0].width)-90;
    }
}
//#endregion
